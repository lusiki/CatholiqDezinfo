...
for (i in 1:num_batches) {
  ...
  dt[start_idx:end_idx, `:=` (
    has_politika = sapply(FULL_TEXT, check_matches, words_vector),
    matched_politika = sapply(FULL_TEXT, function(x) paste(unlist(str_extract_all(x, words_vector)), collapse=", "))
  )]
...
politika <- dt[has_politika==T,]

# write.xlsx2(politika, "C:/Users/lukas/Dropbox/HKS/Projekti/Dezinformacije/Data/Inicjalno citanje/politika.xlsx")
# 
# 
# library(openxlsx)
# write.xlsx(politika, "C:/Users/lukas/Dropbox/HKS/Projekti/Dezinformacije/Data/Inicjalno citanje/politika.xlsx")




# 
# write.csv2(politika, "./politika.csv")
```


```{r echo=F, eval=T, message=F , warning= FALSE}
politika <- read.xlsx("C:/Users/lukas/Dropbox/HKS/Projekti/Dezinformacije/Data/Inicjalno citanje/politika.xlsx") %>% select(-c(1,2))
```
