...
write.xlsx2(fraze, "C:/Users/lukas/Dropbox/HKS/Projekti/Dezinformacije/Data/Inicjalno citanje/fraze.xlsx")
#write.csv2(fraze, "./fraze.csv")
```


```{r echo=F, eval=T, message=F , warning= FALSE}
fraze <- fread("C:/Users/lukas/Dropbox/HKS/Projekti/Dezinformacije/Data/Inicjalno citanje/fraze.csv") %>% select(-c(1,2))
```
