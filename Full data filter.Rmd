...
setDT(proba13)
proba13[, FULL_TEXT := tolower(FULL_TEXT)]
...
num_batches <- ceiling(nrow(proba13) / batch_size)
...
for (i in 1:num_batches) {
  ...
  end_idx <- min(i * batch_size, nrow(proba13))
  ...
  batch_data <- proba13[start_idx:end_idx]
...
catoliq23_13 <- proba13[has_word==T,]
...
write.xlsx(catoliq23, "C:/Users/lukas/Dropbox/HKS/Projekti/Dezinformacije/Data/Inicjalno citanje/catoliq23.xlsx")
