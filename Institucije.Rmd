...
dt <- read_excel("C:/Users/lukas/Dropbox/HKS/Projekti/Dezinformacije/Data/Inicjalno citanje/pravno.xlsx") 
setDT(dt)



institucije  <- c("Ksaver", "HBK", "Opus Dei", "Protagora","Caritas") %>% tolower()
...
words_vector <- str_c("\\b(", str_c(institucije$root, collapse = "|"), ")\\b")
...
#  cat(sprintf("Processing batch %d (rows %d to %d)...\n", i, start_idx, end_idx))
  ...
  dt[start_idx:end_idx, `:=` (
    has_institucija = sapply(FULL_TEXT, check_matches, words_vector),
    matched_institucija = sapply(FULL_TEXT, function(x) paste(unlist(str_extract_all(x, words_vector)), collapse=", "))
  )]
...
institucije <- dt[has_institucija==T,]

#write.xlsx2(institucije, "C:/Users/lukas/Dropbox/HKS/Projekti/Dezinformacije/Data/Inicjalno citanje/institucije.xlsx")
```
...
institucije <- read_excel("C:/Users/lukas/Dropbox/HKS/Projekti/Dezinformacije/Data/Inicjalno citanje/institucije.xlsx") 
setDT(institucije)
...
#write.xlsx2(institucije, "./institucije.xlsx")
```
